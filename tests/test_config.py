...
class SettingsTests(unittest.TestCase):
    def test_defaults_are_local_first(self):
        ...
        self.assertEqual(settings.llama_cpp.model, "gemma-3n-e2b-it")
        self.assertEqual(settings.llama_cpp.model_path, Path("C:/workspace/models/llm/gemma-3n-e2b-it/gemma-3n-E2B-it-Q4_K_M.gguf"))
        self.assertEqual(settings.llama_cpp.endpoint, "http://127.0.0.1:8080")
