...
class SettingsTests(unittest.TestCase):
    def test_defaults_are_local_first(self):
        ...
        self.assertEqual(settings.providers.llm, "llama-cpp")
        self.assertEqual(settings.providers.tts, "azure-embedded")
        self.assertFalse(settings.providers.cloud_fallback_enabled)
        self.assertEqual(settings.foundry.llm_model, "gemma-4-e2b")
        self.assertEqual(settings.llama_cpp.model, "gemma-4-e2b")
